...
public class LoginController<kakao_restapi> {
	...
	public String login(MemberDTO mdto, HttpSession session, 
	      ...
	      MemberDTO dbdto = service.login(u_id);
	      boolean pwdMatch = pwdEncoder.matches(u_pw, dbdto.getU_pw());
	      System.out.println(u_id+"\t"+u_pw);
	      MemberDTO dto = service.login(u_id);//login 인증   
	      System.out.println(dto);
	      String nextPage=null;//이동페이지 저장
	      if(dto!=null && pwdMatch) {//회원인 경우A
