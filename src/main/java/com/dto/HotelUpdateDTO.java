...
public class HotelUpdateDTO {
	...
	public HotelUpdateDTO(String seq, String name, String place, String addr, String hotel_img,
	...
	public String toString() {
		return "HotelUpdateDTO [seq=" + seq + ", name=" + name + ", place=" + place + ", addr=" + addr + ", hotel_img="
				+ hotel_img + ", theFile=" + theFile + "]";
	}
