...
@Alias("AdminHotelPageDTO")
public class AdminHotelPageDTO {
	...
	public AdminHotelPageDTO(List<HotelDTO> list, int curPage, int perPage, int totalCount) {
		super();
		this.list = list;
	...
	public String toString() {
		return "AdminHotelPageDTO [list=" + list + ", curPage=" + curPage + ", perPage=" + perPage + ", totalCount="
				+ totalCount + "]";
	}
