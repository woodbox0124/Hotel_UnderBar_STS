...
<c:if test="${!empty login}">
	...
	<a href="myPage" class="menubar2" style="color: blue; text-decoration: none;" >&nbsp;마이페이지&nbsp;</a>
	<a href="resvMy" class="menubar2" style="color: blue; text-decoration: none;" >예약 확인</a>
	<a href="boardList" class="menubar2" style="color: blue; text-decoration: none;" >Q&A게시판</a>	
</c:if>
<c:if test="${empty login}">
