...
지역:<select class="place booking_input input" id="place booking_input" name="place">
	...
	<br><br>
주소:<input type="text" name="addr" id="sample6_address" value="${hDTO.addr}" class="input" required/><input type="button" onclick="sample6_execDaumPostcode()" value="주소 찾기"><br><br>
